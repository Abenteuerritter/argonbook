...
use Argon\Form\Type\Blog\PostType;
use Argon\Form\Type\Blog\PostPublishType;
...
class PostController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('admin:blog:post:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('admin:blog:post:new.html.twig', array(
            'post' => $post,
    ...
    public function viewAction($slug)
    {
        ...
        return $this->render('admin:blog:post:view.html.twig', array(
            'post' => $post,
        ));
    }
    ...
    public function publishAction(Request $request, $slug)
    {
        ...
        return $this->render('admin:blog:post:publish.html.twig', array(
            'post' => $post,
            'form' => $form->createView(),
        ));
    }
    ...
    public function editAction(Request $request, $slug)
    {
        ...
        return $this->render('admin:blog:post:edit.html.twig', array(
            'post'    => $post,
            'preview' => $preview,
            'form'    => $form->createView(),
        ));
